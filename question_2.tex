  ...
  \begin{proof}~\\
    \begin{itemize}
      ...
      \item[\iffs]
        ...
        \item[\phantom{\imps}]
          This step forms the crux of the proof. It follows in the left to right diretion by setting $t \triangleq \bigcup\limits_{z\in u} t_z$. Then $t_z\subseteq t$ for every $z\in u$ so by the c-relation condition $\forall z\in u\ldotp~(t,z)\in S$.\\[1em]
