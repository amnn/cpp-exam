  ...
  \begin{proof}
    ...
    \begin{itemize}
      ...
      \item[\imps]
        The inclusion map
        \begin{tikzcd}
          (P,\preceq_{\hat{P}}) \arrow[r, hook, "i"] & (P, \preceq_P)
        \end{tikzcd}
      ...
      \item[\imps] The following diagram commutes
        ...
        \begin{center}
          \begin{tikzcd}[sep=large]
            &  (P, \preceq_{\hat{P}}) \arrow[d, "i", hook, two heads]
      ...
      \item[$\star$]
        \begin{itemize}
          ...
          \item[\imps]
            $h(x) = h(y)$
            \marginnote{\textbf{discrete}-$(P,\preceq_{\hat{P}})$}
...
As a corollary to this lemma, we see that any basis vector $w_i\in\Basis{W}$ can be written as a linear combination of vectors in $e(\Basis{V})$, which is a property we will use in our proof of the result.
